  ...
  return (
    <>
      <SlidingPanel.Wrapper
        open={open}
        onClose={onClose}
        className='fixed right-0 left-0 bottom-0 top-0 z-50 h-screen w-full overflow-hidden'
      >
        <SlidingPanel.Content
          position='bottom'
          className='fixed bottom-0 left-0 w-full transition-transform z-50 h-[95vh] dark:border-neutral-900 dark:bg-zinc-950'
        >
          <SlidingPanel.Close
